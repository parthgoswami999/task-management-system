...
import { createTask, deleteTask, updateTask } from '@/store/taskSlice';
import type { Task, TaskFormValues, TaskStatus } from '@/types';
import { TaskBoard } from '@/views/Dashboard/components/TaskBoard';
import { TaskFilters } from '@/views/Dashboard/components/TaskFilters';
import { TaskFormModal } from '@/views/Dashboard/components/TaskFormModal';
  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <section className="rounded-[2rem] border border-white/10 bg-slate-900/50 p-6 shadow-soft">
